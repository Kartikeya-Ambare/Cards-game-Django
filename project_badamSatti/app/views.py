...
def game_view(request, game_id):
    try:
        ...
        return render(request, 'intoBadam_game.html', {'game_id': game_id})
    except Exception as e:
        return redirect('index')
...
def play_card(request, game_id):
    try:
        ...
        # We need to refetch the game object to check the game_over status set by update_game_state_after_move
